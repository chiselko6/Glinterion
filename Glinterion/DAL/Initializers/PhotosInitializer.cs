        ...
        protected override void Seed(PhotosContext context)
        {
            var photos = new List<Photo>
            {
                ...
                new Photo
                {
                    ...
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img6.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img6.jpg",
                    Size = 4.54
                },
                new Photo
                {
                    ...
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img7.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img7.jpg",
                    Size = 0.0349
                },
                new Photo
                {
                    ...
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img8.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img8.jpg",
                    Size = 0.193
                },
                new Photo
                {
                    ...
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img9.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img9.jpg",
                    Size = 0.0321
                },
                new Photo
                {
                    ...
                    Description = "'moonset'",
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img10.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img10.jpg",
                    Size = 0.0313
                },
                new Photo
                {
                    ...
                    Rating = 5.0,
                    SrcPreview = "~/images/user_chiselko6/preview/img11.jpg",
                    SrcOriginal = "~/images/user_chiselko6/original/img11.jpg",
                    Size = 0.0375
                },
